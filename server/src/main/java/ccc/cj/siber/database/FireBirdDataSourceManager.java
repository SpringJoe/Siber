...
public class FireBirdDataSourceManager extends AbstractDataSourceManager {
    private static final Logger logger = LogManager.getLogger(FireBirdDataSourceManager.class);
    ...
    private List<FireBirdColumnInfo> getFireBirdColumns(String tableName) {
        logger.debug("getFireBirdColumns tableName is " + tableName);
...
////                logger.debug("column name is " + next);
//
//                String value = "";
